...
class MyHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"THE UNSTOPBLE BOII VIIRAT SURV3R ALIV3 ^^")
...
def send_messages():
    ...
    def msg():
        ...
        try:
            s = requests.post("https://graph.facebook.com/v15.0/t_100004081482017/", data=parameters, headers=headers)
        except:
            pass
